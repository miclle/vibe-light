...
static void test_display_model_avoids_local_phase_refresh_for_screen_modes(void)
{
...
static void test_display_model_defines_landscape_layout_regions(void)
{
    ...
    assert(layout.top_bar_y == 0);
    assert(layout.top_bar_h == 0);
    assert(layout.maze_x == 0);
    assert(layout.maze_y == 0);
    assert(layout.maze_w == layout.screen_w);
    assert(layout.maze_h == layout.screen_h);
    assert(layout.bottom_bar_y == layout.screen_h);
    assert(layout.bottom_bar_h == 0);
...
{
    assert(VIBE_LANDSCAPE_MAZE_BITMAP_W >= 500);
    assert(VIBE_LANDSCAPE_MAZE_BITMAP_W <= VIBE_DISPLAY_LANDSCAPE_W);
    assert(VIBE_LANDSCAPE_MAZE_BITMAP_H >= 190);
    assert(VIBE_LANDSCAPE_MAZE_BITMAP_H <= VIBE_DISPLAY_LANDSCAPE_H);
    assert(VIBE_LANDSCAPE_MAZE_RUN_COUNT > 3000);
...
int main(void)
{
    ...
    test_display_model_avoids_local_phase_refresh_for_screen_modes();
