...
#define VIBE_DISPLAY_TASK_DETAIL_ROW_STRIDE 56
#define VIBE_DISPLAY_TASK_DETAIL_Y_OFFSET 22
#define VIBE_DISPLAY_TASK_ROW_TEXT_H 14
#define VIBE_DISPLAY_TASK_DETAIL_TEXT_H 7
#define VIBE_DISPLAY_TASK_SWATCH_W 4
#define VIBE_DISPLAY_TASK_SWATCH_H 16
