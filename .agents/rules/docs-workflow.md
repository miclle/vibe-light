...
- Current protocol docs should include Codex usage and task timing if relevant: 5h / 7d remaining percentages, task-level `updatedAt` timing, and `CTX` context used percentage as the trailing-label fallback.
