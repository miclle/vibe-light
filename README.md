...
Vibe Light 目前处于上线前测试阶段，核心链路已经具备 macOS app、ESP32-S3 固件、BLE 状态同步和 app 内固件烧录闭环。
...
发布包可用后，普通测试用户可以直接使用 GitHub release 包，不需要从源码构建固件：

1. 从 [GitHub Releases](https://github.com/miclle/vibe-light/releases) 下载发布包。
