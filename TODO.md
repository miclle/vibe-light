...
3. **处理非阻塞发布治理**
   ...
   - 正式公开 / 商业发布前完成人工法律 / 合规确认，尤其是 bundled `esptool` GPLv2+ source offer 和间接依赖 license 文本。
